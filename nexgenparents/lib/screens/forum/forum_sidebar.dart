        ...
        _SidebarCard(
          ...
          child: Column(
            ...
            children: [
              ...
              _SidebarTopicItem(title: '¿Límites de tiempo para niños de 10 años?', subtitle: '24 respuestas nuevas hoy', isDark: isDark),
              _SidebarTopicItem(title: 'Los mejores juegos educativos en Switch', subtitle: '15 respuestas nuevas hoy', isDark: isDark),
              _SidebarTopicItem(title: 'Cómo gestionar la seguridad en chats online', subtitle: '8 respuestas nuevas hoy', isDark: isDark, showDivider: false),
            ],
          ),
        ),
        const SizedBox(height: 12),
        ...
        _SidebarCard(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              _SidebarReplyItem(avatar: 'S', name: 'Sarah M.', link: 'Seguridad en Fortnite', action: 'respondió a tu co...', time: 'hace 2 minutos', isDark: isDark, avatarColor: const Color(0xFFEC4899)),
              _SidebarReplyItem(avatar: 'D', name: 'David K.', link: 'Comparativa de consolas', action: 'te etiquetó en...', time: 'hace 1 hora', isDark: isDark, avatarColor: const Color(0xFF3B82F6)),
              _SidebarReplyItem(avatar: 'E', name: 'Emily R.', link: 'Hilo de Bienvenida', action: 'le gustó tu respue...', time: 'hace 3 horas', isDark: isDark, avatarColor: const Color(0xFF10B981), showDivider: false),
            ],
          ),
        ),
        const SizedBox(height: 12),
        ...
        _SidebarCard(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 12),
              _SidebarNewsItem(tag: 'Actualización', tagColor: const Color(0xFF8B5CF6), text: 'Nuevas guías de control parental añadidas al Diccionario.', isDark: isDark),
              const SizedBox(height: 8),
              _SidebarNewsItem(tag: 'Evento', tagColor: const Color(0xFF3B82F6), text: 'Q&A en vivo con psicólogo infantil este jueves a las 18:00.', isDark: isDark),
              const SizedBox(height: 8),
              _SidebarNewsItem(tag: 'Novedad', tagColor: const Color(0xFF10B981), text: '¡El modo oscuro ya está disponible en los ajustes de usuario!', isDark: isDark, showDivider: false),
            ],
          ),
        ),
      ],
